 ...
 */
final class Version20241205154050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, is_verified BOOLEAN NOT NULL, firstname VARCHAR(255) NOT NULL, duckname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL)');
